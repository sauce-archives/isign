...
class MonkeyPatchTempFile(object):
    ...
    def patch(cls):
        ...
        tempfile.mkdtemp = MonkeyPatchTempFile.mkdtemp

        tempfile._original_mkstemp = tempfile.mkstemp
        tempfile.mkstemp = MonkeyPatchTempFile.mkstemp

        tempfile._original_NamedTemporaryFile = tempfile.NamedTemporaryFile
        tempfile.NamedTemporaryFile = MonkeyPatchTempFile.NamedTemporaryFile
